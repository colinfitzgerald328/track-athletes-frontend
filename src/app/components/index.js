...
export default class MainComponent extends React.Component {
  ...
  render() {
    ...
    const formattedText = separateSentencesIntoParagraphs(this.state.athlete.summary);
    return (
      <div className={styles.main}>
        <div className={styles.mainBackground}>
          <div className={styles.mainImage}>
            <img className={styles.athleteImage} src={this.state.athlete.hq_image_url} />
          </div>
          <div className={styles.mainText}>
            <div className={styles.container}>
              <div className={styles.mainTitle}>
                <div>
                  {this.state.athlete.full_name}
                </div>
              ...
              <div className={styles.rightContainer}>
                <div onClick={()=> window.open(this.state.athlete.wikipedia_url)} className={styles.openLink}>Read more</div>
                <div className={styles.socialIconHolder}>
                  <img onClick={()=> window.open(this.state.athlete.instagram_url)} className={styles.image} src="https://worldathletics.org/static/instagram.svg" />
                </div>
              </div>
            </div>
